...
//const int NUM_PARTICLES = 33554432;
...
Display( )
{
	...
	if( ShowPerformance )
	{
		...
		sprintf( str, "%6.3f GigaParticles/Sec Animate ", (float)NUM_PARTICLES/ElapsedTime/1000000000. );
		double GigaParticles = (float)NUM_PARTICLES / ElapsedTime / 1000000000.;

		if (!isinf(GigaParticles))
		{
			if (GigaParticles > maxGigaParticles)
				maxGigaParticles = GigaParticles;
			printf("%6.3f GigaParticles/Sec Peak \n", maxGigaParticles);
		}
...
InitLists( )
{
	...
	// ****************************************
		...
		glColor3f(0.0f, 1.0f, 1.0);	// 0. <= r,g,b <= 1.
		glPushMatrix( );
			glTranslatef( -800.f, -200.f, 0.f );
	...
	// do this for yourself...
		glColor3f(0.0f, 0.0f, 1.0);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(800.f, -200.f, 0.f);
		glutWireSphere(600.f, 100, 100);
		glPopMatrix();

		glColor3f(0.8f, 0.8f, 0.0);	// 0. <= r,g,b <= 1.
		glPushMatrix();
		glTranslatef(0.f, -1200.f, 0.f);
		glutWireSphere(600.f, 100, 100);
		glPopMatrix();
...
Reset( )
{
	//printf("%6.1f GigaParticles/Sec", maxGigaParticles);
...
ResetParticles( )
{
	printf("%6.3f GigaParticles/Sec Reset", maxGigaParticles);
	glBindBuffer( GL_ARRAY_BUFFER, hPobj );
