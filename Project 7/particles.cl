...
Particle( global point *dPobj, global vector *dVel, global color *dCobj )
{
	...
	const float  DT      = 0.1;
	const sphere Sphere1 = (sphere)( -800., -200., 0.,  600. );
	const sphere Sphere2 = (sphere)( 800., -200., 0.,  600. );
	const sphere Sphere3 = (sphere)( 0., -1200., 0.,  600. );
